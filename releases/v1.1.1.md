...
Raspbian Trixie Auto-Updater v1.1.1 - Automatisches Update-System für Raspbian/Debian Trixie mit detaillierter Statusanzeige und Desktop-Benachrichtigungen.
...
- fix: Behebe ShellCheck und Bandit Security Warnungen

## 🔒 Sicherheit

- Keine Sicherheitsupdates in diesem Release
...
- [GitHub Release](https://github.com/roimme65/raspbian-updater/releases/tag/v1.1.1)
